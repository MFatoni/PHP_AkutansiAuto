<?php include('../../includes/templateinput.php') ?>
		<div class="col-lg-10">
			...
			<div class="container-fluid">
				<form action="../perperiode/jurnalPenyesuaian.php" method="POST">
                <table class="table">
                    <tr>
                        <td>Pilih Periode</td>
                        <td >
                ...
                <i>*Apabila Jurnal Penyesuian Kosong, Generatelah Telebih Dahulu Data Yang Dimasukkan Di Sub Menu Neraca Lajur</i>
			</div>
		</div>
	</div>
</body>
