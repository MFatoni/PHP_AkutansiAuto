		...
		<div class="col-lg-10">
			...
			<div class="container-fluid">
				<?php
			        ...
			        $query = mysqli_query($con,"select*from transaksi inner join ketref on ketref.noRef = transaksi.noRef order by ketref.noRef, transaksi.tanggal");
			        $query1 = mysqli_query($con,"select*from transaksi inner join ketref on ketref.noRef = transaksi.noRef where (ketref.noRef <> 19 and ketref.noRef <> 57) group by ketref order by transaksi.noRef");
