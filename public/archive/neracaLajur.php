		...
		<div class="col-lg-10">
			...
			<div class="container-fluid">
				<table border="1" class="table table-sm">
			        ...
			        $query = mysqli_query($con,"select*from neracalajur inner join ketref on ketref.noRef = neracalajur.noRef order by neracalajur.noRef ");
					...
					<?php 
				        if (mysqli_connect_errno()){
				            ...
				            $query1 =mysqli_query($con,"select sum(rugiLabaD), sum(rugiLabaK), sum(neracaD), sum(neracaK) from neracalajur"); 
