		...
		<div class="col-lg-10">
			...
			<div class="container-fluid table-responsive">
				...
				<?php
			        ...
			        $query = mysqli_query($con,"select*from transaksi inner join ketref on ketref.noRef = transaksi.noRef order by tanggal,no, kdTransaksi");
			        $no=1;
			        $param=0;
				...
				<tr>
					...
					<?php 
							...
							$query = mysqli_query($con,"select sum(debet), sum(kredit) from transaksi ");
