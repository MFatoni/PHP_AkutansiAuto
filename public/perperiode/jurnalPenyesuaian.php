				...
				<table border="1" class="table table-sm">
					...
					<?php
					    ...
					    if (mysqli_connect_errno()){
							...
							$query = mysqli_query($con,"select*from neracalajur inner join ketref on ketref.noRef = neracalajur.noRef  where (penyesuaianD <> 0 or penyesuaianK <> 0) and idnl like '$periode%' order by kdUnik ,ketref.noRef");
							$param=0;
